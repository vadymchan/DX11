...
float4 main(Input input) : SV_TARGET
{
    ...
    {
        case 0:
            color = modelTexture.Sample(g_pointWrap, input.texCoord);
            break;
        case 1:
            color = modelTexture.Sample(g_linearWrap, input.texCoord);
            break;
        case 2:
            color = modelTexture.Sample(g_anisotropicWrap, input.texCoord);
            break;
        default:
            color = modelTexture.Sample(g_anisotropicWrap, input.texCoord);
            break;
